...
func (s *CreateOrderRequestDto) Validate() error {
	if s == nil {
...
func (s *CreateOrderResponseDto) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *GetOrderResponseDto) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *PayOrderRequestDto) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
