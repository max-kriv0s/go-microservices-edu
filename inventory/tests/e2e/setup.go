...
import (
	...
	"github.com/max-kriv0s/go-microservices-edu/platform/pkg/testcontainers"
	"github.com/max-kriv0s/go-microservices-edu/platform/pkg/testcontainers/app"
	"github.com/max-kriv0s/go-microservices-edu/platform/pkg/testcontainers/mongo"
	"github.com/max-kriv0s/go-microservices-edu/platform/pkg/testcontainers/network"
	"github.com/max-kriv0s/go-microservices-edu/platform/pkg/testcontainers/path"
)
